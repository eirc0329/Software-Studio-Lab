                    ...
                    <div className='bg-faded'>
                        <div className='container'>
                            <Navbar color='faded' dark>
                                <button className="navbar-dark navbar-toggler fancy-toggler navbar-toggler btn" type="button" data-toggle="collapse" onClick={this.handleNavbarToggle}>
                                ...
                                <Collapse isOpen={this.state.navbarToggle} navbar>
                                    <Nav navbar>
                                        <NavItem>
                                            <NavLink className="text-white" tag={Link} to='/'>Today</NavLink>
                                        </NavItem>
                                        <NavItem>
                                            <NavLink className="text-white" tag={Link} to='/forecast'>Forecast</NavLink>
                                        </NavItem>
                                    </Nav>
